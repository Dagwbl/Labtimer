...
<template>
  ...
  >
    ...
    <div
      role="button"
      tabindex="0"
      class="w-full text-left px-4 py-1 rounded-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 cursor-pointer transition-transform active:scale-[0.98]"
      @click="navigateToRun"
